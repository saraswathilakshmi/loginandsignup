...
class _ForgotPasswordVerificationPageState extends State<ForgotPasswordVerificationPage> {
  ...
  OTPTextField({required int length, required int width, required int fieldWidth, required TextStyle style, required MainAxisAlignment textFieldAlignment, required fieldStyle, required Null Function(dynamic pin) onCompleted}) {}
}